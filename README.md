...
Below is 
<img src=img/ayinde.zurada.figure2.png width=200px caption='Figure 3, taken from Figure 2 of Ayinde & Zurada (2017)'>

## References
Ayinde, B. O., & Zurada, J. M. (2017). Deep learning of constrained autoencoders for enhanced understanding of data. *IEEE transactions on neural networks and learning systems, 29(9)*, 3969-3979.